---
description: "llms.txt es un archivo de texto en formato Markdown que se ubica en la raíz de un sitio web (como https://tusitio.com/llms.txt). Su función principal es…"
---
